          ...
          {!submitted ? (
            <form
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="items-center justify-center w-full">
                    ...
                    <FormControl>
                      <Textarea style={{ height: "100px" }} {...field} className="bg-white" />
                    </FormControl>
                  </FormItem>
                )}
              />
              <div className="flex gap-4 items-center">
                <div>
                  <Checkbox
                    className="outline border-2 border-white bg-gray-100 text-sm font-light bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400"
                  />
                </div>
              ...
              <div className="flex items-center gap-4">
                <Button
                  type="submit"
                  className="text-sm font-light bg-white hover:bg-gray-200"
                  disabled={loading}
