...
const stores = [
    ...
    },
    {
        ...
        quote : "We had no idea how to get started, but Bird showed us the way. And we ware ableto create something amazing.",
        name : "John Prency",
    },
    {
  ...
  return (
    <section className='mt-10 md:py-10 bg-[#f6f5f4] w-full rounded-3xl'>
        <div className="p-4 mx-auto relative z-10 w-full">
            <div className='text-4xl py-10 md:pb-8 md:text-7xl text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 to-neutral-50'>
                Shopify Store <br />
            </div>
